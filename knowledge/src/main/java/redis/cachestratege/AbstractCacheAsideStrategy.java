...
public abstract class AbstractCacheAsideStrategy implements StorageOperate<String> {
    protected MySqlStorageOperation mySqlStorageOperation = new MySqlStorageOperation();
    protected RedisStorageOperation redisStorageOperation = new RedisStorageOperation();
    ...
    protected ExecutorService executorService = new ThreadPoolExecutor(10, 20, 10, TimeUnit.SECONDS,
        ...
        public Thread newThread(Runnable r) {
            ...
            String threadName = String.format("-%s", Integer.valueOf(THREAD_COUNT.getAndIncrement()));
